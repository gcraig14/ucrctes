...
$param = array(
	'name'			=> esc_attr__( 'Top Rated Products', 'sobari_sc' ),
	'base'			=> 'dahz_product_top_rated',
	'category'	=> array( 'WooCommerce' ),
	'description'	=> esc_attr__( 'List all top rated product', 'sobari_sc' ),
	'icon'			=> DAHZEXTENDER_SHORTCODE_URI . "assets/images/icon/df_element-icon-woo-top-rated.svg",
	'params'		=> array()
);
