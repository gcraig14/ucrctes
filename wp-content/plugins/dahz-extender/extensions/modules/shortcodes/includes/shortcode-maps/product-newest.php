...
*/
$param = array(
	'name'			=> esc_attr__( 'Newest Product', 'sobari_sc' ),
	'base'			=> 'dahz_product_newest',
	'category'	=> array( 'WooCommerce' ),
	'description'	=> esc_attr__( 'Lists recent products', 'sobari_sc' ),
	'icon'			=> DAHZEXTENDER_SHORTCODE_URI . "assets/images/icon/df_element-icon-woo-recent-products.svg",
	'params'		=> array()
);
