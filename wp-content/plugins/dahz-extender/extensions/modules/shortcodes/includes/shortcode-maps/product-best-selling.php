...
$param = array(
	'name'			=> esc_attr__( 'Best Selling Products', 'sobari_sc' ),
	'base'			=> 'dahz_product_best_sellings',
	'category'	=> array( 'WooCommerce' ),
	'description'	=> esc_attr__( 'List all best salling products', 'sobari_sc' ),
	'icon'			=> DAHZEXTENDER_SHORTCODE_URI . "assets/images/icon/df_element-icon-woo-best-selling.svg",
	'params'		=> array()
);
