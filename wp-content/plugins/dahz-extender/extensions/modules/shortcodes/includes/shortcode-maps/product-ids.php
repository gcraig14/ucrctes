...
*/
$param = array(
	'name'			=> esc_attr__( 'Product By ids / SKU', 'sobari_sc' ),
	'base'			=> 'dahz_product_ids',
	'category'	=> array( 'WooCommerce' ),
	'description'	=> esc_attr__( 'Show multiple products by ID or SKU', 'sobari_sc' ),
	'icon'			=> DAHZEXTENDER_SHORTCODE_URI . "assets/images/icon/df_element-icon-id-sku.svg",
	'params'		=> array()
);
