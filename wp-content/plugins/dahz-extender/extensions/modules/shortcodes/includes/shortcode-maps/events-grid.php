...
$param = array(
	'name'				=> esc_attr__( 'Events Grid', 'sobari_sc' ),
	'base'				=> 'events_grid',
	'category'	=> array( 'Content' ),
	'description'		=> esc_attr__( 'Display events grid in styles', 'sobari_sc' ),
...
$param['params'][] = array(
	'type' 			=> 'radio_image',
	'heading' 		=> esc_attr__( 'Post Grid Style', 'sobari_sc' ),
...
$param['params'][] = array(
	...
	'description'	=> esc_attr__( 'Select post grid box shadow style', 'sobari_sc' ),
    'group' 	    => esc_attr__( 'Styling', 'sobari_sc' ),
);
...
$param['params'][] = array(
	...
	'description'	=> esc_attr__( 'Select post grid hover hover box shadow style', 'sobari_sc' ),
    'group' 	    => esc_attr__( 'Styling', 'sobari_sc' ),
);
