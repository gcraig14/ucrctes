...
$param = array(
	'name'			=> esc_attr__( 'Featured Products', 'sobari_sc' ),
	'base'			=> 'dahz_product_featured',
	'category'	=> array( 'WooCommerce' ),
	'description'	=> esc_attr__( 'Display products set as featured', 'sobari_sc' ),
	'icon'			=> DAHZEXTENDER_SHORTCODE_URI . "assets/images/icon/df_element-icon-woo-featured-products.svg",
	'params'		=> array()
);
