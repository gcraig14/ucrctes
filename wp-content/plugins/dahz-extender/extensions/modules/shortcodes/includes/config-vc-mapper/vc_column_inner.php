...
return array(
	...
	array(
		...
		'param_name' => 'custom_responsive_translate_el_col_inner',
	...
	array(
		'type'			=> 'textfield',
		'param_name'	=> 'col_inner_translate_x_xsmall',
		'description'	=> __( 'Set how much the element has to translate in the X axis. Dont include "px" in your strings(ex: 40). Negative Values are also accepted', 'sobari_sc' ),
		'group'			=> __( 'Extra', 'sobari_sc' ),
		'heading'		=> __( 'Translate X <br /> for Extra Small ( Phone Potrait )', 'sobari_sc' ),
		'edit_field_class'	=> 'vc_col-sm-6',
		'dependency'	=> array(
			'element'	=> 'custom_responsive_translate_el_col_inner',
			'not_empty'	=> true,
		)
	),
	array(
		'type'			=> 'textfield',
		'param_name'	=> 'col_inner_translate_y_xsmall',
		'description'	=> __( 'Set how much the element has to translate in the Y axis. Dont include "px" in your strings(ex: 40). Negative Values are also accepted', 'sobari_sc' ),
		'group'			=> __( 'Extra', 'sobari_sc' ),
	...
	array(
		'type'			=> 'textfield',
		'param_name'	=> 'col_inner_translate_x_small',
		'description'	=> __( 'Set how much the element has to translate in the X axis. Dont include "px" in your strings(ex: 40). Negative Values are also accepted', 'sobari_sc' ),
		'group'			=> __( 'Extra', 'sobari_sc' ),
	...
	array(
		'type'			=> 'textfield',
		'param_name'	=> 'col_inner_translate_y_small',
		'description'	=> __( 'Set how much the element has to translate in the Y axis. Dont include "px" in your strings(ex: 40). Negative Values are also accepted', 'sobari_sc' ),
		'group'			=> __( 'Extra', 'sobari_sc' ),
	...
	array(
		'type'			=> 'textfield',
		'param_name'	=> 'col_inner_translate_x_med',
		'description'	=> __( 'Set how much the element has to translate in the X axis. Dont include "px" in your strings(ex: 40). Negative Values are also accepted', 'sobari_sc' ),
		'group'			=> __( 'Extra', 'sobari_sc' ),
	...
	array(
		'type'			=> 'textfield',
		'param_name'	=> 'col_inner_translate_y_med',
		'description'	=> __( 'Set how much the element has to translate in the Y axis. Dont include "px" in your strings(ex: 40). Negative Values are also accepted', 'sobari_sc' ),
		'group'			=> __( 'Extra', 'sobari_sc' ),
