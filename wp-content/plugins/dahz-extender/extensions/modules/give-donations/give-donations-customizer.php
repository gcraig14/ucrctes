...
if ( !class_exists( 'Dahzextender_Archive_Give_Donations_Customizer' ) ) {

	Class Dahzextender_Archive_Give_Donations_Customizer extends Dahz_Framework_Customizer_Extend {
		...
		public function dahz_framework_set_customizer() {
			...
			$dv_field[] = array(
				...
				'active_callback'	=> array(
					array(
						'setting'	=> 'archive_donations_column',
						'operator'	=> '!=',
						'value'		=> '1',
					)
				),
...
if ( !class_exists( 'Dahzextender_General_Give_Donations_Customizer' ) ) {

	Class Dahzextender_General_Give_Donations_Customizer extends Dahz_Framework_Customizer_Extend {
		...
		public function dahz_framework_set_customizer() {
			...
			$dv_field[] = array(
				...
				'label'       => __( 'Donate Button Style', 'baklon' ),
