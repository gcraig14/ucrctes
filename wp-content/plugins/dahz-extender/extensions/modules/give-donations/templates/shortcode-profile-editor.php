	...
	<form id="give_profile_editor_form" class="give-form" action="<?php echo give_get_current_page_url(); ?>" method="post">
		<fieldset>
			...
			<p id="give_profile_submit_wrap">
				...
				<button name="give_profile_editor_submit" id="give_profile_editor_submit" type="submit"
				       class="give_submit uk-button uk-button-default"><?php _e( 'Save Changes', 'give' ); ?></button>
			</p>
