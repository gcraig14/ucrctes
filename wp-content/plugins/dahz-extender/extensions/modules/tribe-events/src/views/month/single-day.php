...
<!-- Day Header -->
<div id="tribe-events-daynum-<?php echo $day['daynum-id'] ?>" class="uk-text-left@m uk-text-center de-tribe-events-daynum">
...
<?php //if ( $day['total_events'] > 0 && tribe_events_is_view_enabled( 'day' ) ) : ?>
	...
	<div class="uk-hidden@m uk-text-center">
		<a data-uk-icon="info" class="uk-hidden@m uk-text-center"></a>
		<div data-uk-dropdown="" class="uk-background-default">
...
<?php if ( $day['view_more'] ) : ?>
	<div class="tribe-events-viewmore uk-text-small uk-margin-remove uk-text-center">
		<?php
		...
		?>
		<a class="uk-link" href="<?php echo esc_url( $day['view_more'] ); ?>" aria-label="<?php echo esc_attr( $view_all_aria_label ); ?>">
