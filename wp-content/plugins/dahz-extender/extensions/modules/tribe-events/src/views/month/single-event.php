...
<div id="tribe-events-event-<?php echo esc_attr( $event_id ); ?>" class="uk-visible@m <?php tribe_events_event_classes() ?>" data-tribejson='<?php echo esc_attr( tribe_events_template_data( $post ) ); ?>'>
	<h3 class="tribe-events-month-event-title uk-h4 uk-margin-remove"><a href="<?php echo esc_url( $link ) ?>" class="url"><?php echo $title ?></a></h3>
