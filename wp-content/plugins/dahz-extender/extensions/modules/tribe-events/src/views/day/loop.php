...
<div id="tribe-events-day" class="tribe-events-loop">
	...
	<div class="tribe-events-day-time-slot" data-uk-margin="margin:uk-margin">
		<h2 class="uk-h4 uk-heading-line uk-margin-medium uk-margin-medium-top"><span><?php echo $current_timeslot; ?></span></h2>
		<?php endif; ?>
