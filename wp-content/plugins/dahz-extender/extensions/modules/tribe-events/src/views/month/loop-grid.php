...
<?php do_action( 'tribe_events_before_the_grid' ) ?>
	...
	<div class="uk-flex-column" data-uk-margin="margin:uk-margin">
		<table class="tribe-events-calendar uk-table">
			...
			<thead>
			<tr class="de-tribe-events-calendar-heading">
				<?php foreach ( $days_of_week as $day ) : ?>
					<th class="uk-text-center" id="tribe-events-<?php echo esc_attr( strtolower( $day ) ); ?>" title="<?php echo esc_attr( $day ); ?>" data-day-abbr="<?php echo esc_attr( $wp_locale->get_weekday_abbrev( $day ) ); ?>"><?php echo $day ?></th>
				<?php endforeach; ?>
			</tr>
			</thead>
			<tbody>
			...
			<tr>
				...
				<td class="<?php tribe_events_the_month_day_classes() ?> uk-box-shadow-hover-large" style="vertical-align:top!important;"
