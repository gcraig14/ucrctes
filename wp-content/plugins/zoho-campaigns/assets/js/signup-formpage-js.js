...
jQuery(document).ready(function () {
    ...
    data = {
     ...
     jQuery.post(ajaxurl, data, function(response) {
            ...
            else if(zc_domain_url.indexOf("in")>-1)
            {
                zc_new_domain_url = zc_new_domain_url.replace("com","in");
            }
    ...
    if(typeof zc_saved_page != "undefined" &&zc_saved_page == true)   {
        if(zc_saved_form == 's')    {
    ...
    if (typeof zc_saved_id!= "undefined" && typeof zc_all_idval!= "undefined" && (zc_saved_id == -1 || zc_all_idval.length == zc_unsaved_idval.length)) {
        jQuery("#saved_list_content").css("display","none");
    ...
    } else if(typeof zc_all_idval!="undefined") {
